...
namespace KilnGod.PlotlyCharts.Common
{
	...
	public class LayoutAxisInfo : ValuesObject
	{

		public LayoutAxisInfo():base()		{		}
		...
		public double? XAxis
		{
			get { return (ValueItems as dynamic).layoutattributes.xaxis; }
			set { (ValueItems as dynamic).layoutattributes.xaxis = value; }
		}
		...
		RangeSelectorInfo? _RangeSelector = null;
		public RangeSelectorInfo? RangeSelector
		{
			get { return _RangeSelector; }
			set
			{
				_RangeSelector = value;
				(ValueItems as dynamic).rangeselector = _RangeSelector?.ValueItems;
			}
		}

		RangeSliderInfo? _RangeSlider = null;
		public RangeSliderInfo? RangeSlider
		{
			get { return _RangeSlider; }
			set
			{
				_RangeSlider = value;
				(ValueItems as dynamic).rangeslider = _RangeSlider?.ValueItems;
			}
		}
