...
namespace KilnGod.PlotlyCharts.Common
{
	...
	public class LineParCatsInfo : ValuesObject
	{

		public LineParCatsInfo():base()		{		}
		...
		public ShapeLineParCatsOptions? Shape
		{
			get { return EnumerationStatic.GetValueFromDescription<ShapeLineParCatsOptions> ((ValueItems as dynamic).shape); }
