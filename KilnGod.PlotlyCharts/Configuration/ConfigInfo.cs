...
namespace KilnGod.PlotlyCharts.Configuration
{
	...
	public class ConfigInfo : ValuesObject
	{
		...
		{
			get { return EnumerationStatic.GetValueFromDescription<ScrollZoomOptions>((ValueItems as dynamic).scrollzoom); }
			set { (ValueItems as dynamic).scrollzoom = value?.GetDescription(); }
		}
