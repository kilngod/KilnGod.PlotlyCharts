...
namespace KilnGod.PlotlyCharts.Layout
{
	...
	public class ItemsLayerInfo : ValuesObject
	{

		public ItemsLayerInfo() : base() { }
		...
		{
			get { return EnumerationStatic.GetValueFromDescription<LayerTypeOptions>((ValueItems as dynamic).layertype); }
			set { (ValueItems as dynamic).layertype = value?.GetDescription(); }
		}

	    KilnGod.PlotlyCharts.Layout.LineInfo? _Line = null;
		public KilnGod.PlotlyCharts.Layout.LineInfo? Line
		{
			get { return _Line; }
			set
			{
