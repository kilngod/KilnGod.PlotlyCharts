...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class FunnelTrace : Trace
	{
		...
		public FunnelTrace():base(TraceOptions.Funnel)		{		}
		...
		FunnelConnectorInfo? _Connector = null;
		public FunnelConnectorInfo? Connector
		{
		...
		FunnelHoverOptions[]? _HoverInfo = null;
		public FunnelHoverOptions[]? HoverInfo
		{
		...
		MarkerFunnelInfo? _Marker = null;
		public MarkerFunnelInfo? Marker
		{
			get { return _Marker; }
			set
			{
		...
		TextFontInfo? _OutsideTextFont = null;
		public TextFontInfo? OutsideTextFont
		{
		...
		FunnelTextInfoOptions[]? _TextInfo = null;
		public FunnelTextInfoOptions[]? TextInfo
		{
