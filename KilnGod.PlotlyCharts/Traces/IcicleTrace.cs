...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class IcicleTrace : Trace
	{
		...
		public IcicleTrace():base(TraceOptions.Icicle)		{		}
		...
		IcicleHoverOptions[]? _HoverInfo = null;
		public IcicleHoverOptions[]? HoverInfo
		{
		...
		TextFontSizesInfo? _InsideTextFont = null;
		public TextFontSizesInfo? InsideTextFont
		{
		...
		MarkerIcicleInfo? _Marker = null;
		public MarkerIcicleInfo? Marker
		{
			get { return _Marker; }
			set
			{
		...
		TextFontSizesInfo? _OutsideTextFont = null;
		public TextFontSizesInfo? OutsideTextFont
		{
		...
		PathBarInfo? _PathBar = null;
		public PathBarInfo? PathBar
		{
			get { return _PathBar; }
			set
			{
				_PathBar = value;
				(ValueItems as dynamic).pathbar = _PathBar?.ValueItems;
			}
		}
		...
		IcicleTextInfoOptions[]? _TextInfo = null;
		public IcicleTextInfoOptions[]? TextInfo
		{
		...
		public IcicleTextPositionOptions? TextPosition
		{
			get { return EnumerationStatic.GetValueFromDescription<IcicleTextPositionOptions> ((ValueItems as dynamic).textposition); }
		...
		IcicleTilingInfo? _Tiling = null;
		public IcicleTilingInfo? Tiling
		{
			get { return _Tiling; }
			set
			{
