...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class ImageTrace : Trace
	{

		public ImageTrace():base(TraceOptions.Image)		{		}

		public ColorModelOptions? ColorModel
		{
			get { return EnumerationStatic.GetValueFromDescription<ColorModelOptions> ((ValueItems as dynamic).colormodel); }
			set { (ValueItems as dynamic).colormodel = value?.GetDescription(); }
		}
		...
		ImageHoverOptions[]? _HoverInfo = null;
		public ImageHoverOptions[]? HoverInfo
		{
