...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class PieTrace : Trace
	{
		...
		public PieTrace():base(TraceOptions.Pie)		{		}
		...
		MarkerPieInfo? _Marker = null;
		public MarkerPieInfo? Marker
		{
			get { return _Marker; }
			set
			{
		...
		public double? Pull
		{
			get { return (ValueItems as dynamic).pull; }
			set { (ValueItems as dynamic).pull = value; }
		}
