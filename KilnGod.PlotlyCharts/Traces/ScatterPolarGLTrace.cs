...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class ScatterPolarGLTrace : Trace
	{

		public ScatterPolarGLTrace():base(TraceOptions.ScatterPolarGL)		{		}
		...
		public FillPolarGLOptions? Fill
		{
			get { return EnumerationStatic.GetValueFromDescription<FillPolarGLOptions> ((ValueItems as dynamic).fill); }
		...
		PolarHoverOptions[]? _HoverInfo = null;
		public PolarHoverOptions[]? HoverInfo
		{
		...
		MarkerPolarGLInfo? _Marker = null;
		public MarkerPolarGLInfo? Marker
		{
			get { return _Marker; }
			set
			{
		...
		public PolarThetaUnitOptions? ThetaUnit
		{
			get { return EnumerationStatic.GetValueFromDescription<PolarThetaUnitOptions> ((ValueItems as dynamic).thetaunit); }
