...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class ScatterSmithTrace : Trace
	{
		...
		public ScatterSmithTrace():base(TraceOptions.ScatterSmith)		{		}
		...
		public FillSmithInfo? Fill
		{
			get { return EnumerationStatic.GetValueFromDescription<FillSmithInfo> ((ValueItems as dynamic).fill); }
		...
		ScatterSmithHoverOptions[]? _HoverInfo = null;
		public ScatterSmithHoverOptions[]? HoverInfo
		{
