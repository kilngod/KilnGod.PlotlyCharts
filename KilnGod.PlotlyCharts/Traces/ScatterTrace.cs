...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class ScatterTrace : Trace
	{
		...
		public ScatterTrace():base(TraceOptions.Scatter)		{		}
		...
		FillPatternInfo? _FillPattern = null;
		public FillPatternInfo? FillPattern
		{
			get { return _FillPattern; }
			set
			{
				_FillPattern = value;
				(ValueItems as dynamic).fillpattern = _FillPattern?.ValueItems;
			}
		}

		public NormalizationOptions? GroupNorm
		{
			get { return EnumerationStatic.GetValueFromDescription<NormalizationOptions> ((ValueItems as dynamic).groupnorm); }
			set { (ValueItems as dynamic).groupnorm = value?.GetDescription(); }
		}
		...
		LineScatterInfo? _Line = null;
		public LineScatterInfo? Line
		{
			get { return _Line; }
			set
			{
		...
		public StackGapsOptions? StackGaps
		{
			get { return EnumerationStatic.GetValueFromDescription<StackGapsOptions> ((ValueItems as dynamic).stackgaps); }
			set { (ValueItems as dynamic).stackgaps = value?.GetDescription(); }
		}

		public string? StackGroup
		{
			get { return (ValueItems as dynamic).stackgroup; }
			set { (ValueItems as dynamic).stackgroup = value; }
		}
