...
namespace KilnGod.PlotlyCharts.Traces
{
	...
	public class TreemapTrace : Trace
	{
		...
		public TreemapTrace():base(TraceOptions.Treemap)		{		}
		...
		MarkerTreemapInfo? _Marker = null;
		public MarkerTreemapInfo? Marker
		{
			get { return _Marker; }
			set
			{
		...
		public TreemapTextPositionOptions? TextPosition
		{
			get { return EnumerationStatic.GetValueFromDescription<TreemapTextPositionOptions> ((ValueItems as dynamic).textposition); }
		...
		TreemapTilingInfo? _Tiling = null;
		public TreemapTilingInfo? Tiling
		{
			get { return _Tiling; }
			set
			{
